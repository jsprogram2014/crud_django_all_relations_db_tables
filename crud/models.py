...
class User(models.Model):
    ...
    last_name = models.CharField(null=False, max_length=30, default='smith')
    dob = models.DateField(null=True)

    # going to create a to_String method so it can return objects as strings

    def __str__(self):
        return self.first_name + ' ' + self.last_name
    
# following Instructor class will be an extension of User class
