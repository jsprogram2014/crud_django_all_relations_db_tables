...
from crud.models import User, Instructor


def write_instructors():
    # Add instructors
    # Create a user
    user_max=User(first_name='max',last_name='smith', dob=date(1923,4,5))
    user_max.save()

    instructor_max= Instructor(full_time = False, total_learners = 30050)
    instructor_max.user=user_max
    instructor_max.save()
...
## the following methods erase my tables datas
def clean_data():
